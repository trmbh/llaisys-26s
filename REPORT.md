...
| NVIDIA CUDA | Supported | `test/test_runtime.py --device nvidia` passed on an RTX 5070 Ti Laptop GPU. Native Qwen2 synthetic-model generation matched the CPU result. |
